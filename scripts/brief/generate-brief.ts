...
const gapAuditDrafts: DraftEvidence[] = [
    ...
    whyItMatters: "Subscriber count and growth rate are central scale metrics for the Starlink business and are not captured by the existing business cards.",
    confidence: "high",
    extractionMethod: "gap-audit-business",
    ...
    {
    topic: "business",
    title: "Starlink generated $11,387 million of revenue and $4,423 million of operating income in 2025",
    ...
    extractedText: "Starlink: $11,387 million revenue, $4,423 million operating income, $7,168 million Segment Adjusted EBITDA in 2025.",
    plainEnglish: "For full-year 2025, SpaceX's Starlink business generated $11,387 million of revenue, $4,423 million of income from operations, and $7,168 million of Segment Adjusted EBITDA, which the filing presents as year-over-year growth of 49.8%, 120.4%, and 86.2% respectively.",
    whyItMatters: "It shows Starlink is the company's profit driver, a material part of the segment picture not covered by existing cards.",
    confidence: "high",
    extractionMethod: "gap-audit-business",
    ...
    whyItMatters: "Enterprise customer retention is a stated indicator of revenue durability in the Starlink business and is not covered by existing cards.",
    confidence: "medium",
    extractionMethod: "gap-audit-business",
    ...
    plainEnglish: "Revenue for the three months ended March 31, 2026 increased by $627 million, or 15.4%, year over year, which the company attributes mainly to higher Starlink revenue and higher launch revenue.",
    ...
    {
    topic: "financial",
    title: "Starlink revenue grew on 104.7% subscriber growth offset by a 22.9% ARPU decline.",
    ...
    extractedText: "Starlink revenue grew on 104.7% subscriber growth offset by a 22.9% ARPU decline.",
    plainEnglish: "Starlink consumer revenue rose $656 million, driven by 104.7% growth in Starlink Subscribers, partially offset by a 22.9% decline in Starlink Subscriber ARPU (average revenue per user) that the company attributes to international expansion and lower-priced plans.",
...
function riskWhyItMatters(theme: string, subject?: string): string {
  const byTheme: Record<string, string> = {
    ...
    "Starlink/connectivity": "It bears on the Starlink business the filing presents as a growth driver.",
